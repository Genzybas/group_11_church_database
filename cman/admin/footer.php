<div class="setfooter">
		<footer >
           <p align="center"><h3 align="center"> &copy; GROUP BASED CHAPEL <?php
 $date = new DateTime();
 echo $date->format(' Y');
 ?> </h3></p>
		 <h3> <p align="center"><h3 align="center"><strong> Designed by: <a href="#" target="_blank" >GROUP BASED</a></h3></strong></p>
